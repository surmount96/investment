    ...
    <div class="flex flex-wrap" style="height: 100vh">
        ...
        <div class="lg:w-1/2 md:w-1/2 w-full bg-blue-deep">
            ...
            <div class="lg:px-20 md:px-12 px-4 py-10">
                <h3 class="text-white text-h4 mt-2">{{ __('Reset Password') }}</h3>
                <form method="POST" action="{{ route('password.update') }}">
                    ...
                    <button type="submit" class="text-body-2 bg-yellow rounded-full text-white w-40 py-3 my-4">{{ __('Reset Password') }}</button>
                </form>
            </div>
        </div>
    </div>
